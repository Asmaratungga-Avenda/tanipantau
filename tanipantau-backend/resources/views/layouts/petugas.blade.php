...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('petugas.dashboard') }}" class="nav-link {{ request()->routeIs('petugas.dashboard') ? 'active' : '' }}" title="Dashboard">
            ...
            <div class="nav-item">
                <a href="{{ route('petugas.lahan.index') }}" class="nav-link {{ request()->routeIs('petugas.lahan.*') ? 'active' : '' }}" title="Lahan Saya">
            ...
            <div class="nav-item">
                <a href="{{ route('petugas.kunjungan.index') }}" class="nav-link {{ request()->routeIs('petugas.kunjungan.*') ? 'active' : '' }}" title="Kunjungan Saya">
            ...
            <div class="nav-item">
                <a href="{{ route('petugas.profile.edit') }}" class="nav-link {{ request()->routeIs('petugas.profile.*') ? 'active' : '' }}" title="Profil Saya">
            ...
            <div class="topbar-right">
                ...
                <div class="profile-dropdown" id="profileDropdown">
                    ...
                    <div class="dropdown-menu-custom">
                        <a href="{{ route('petugas.profile.edit') }}" class="dropdown-item-custom">
